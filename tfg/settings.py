...
SECRET_KEY = '1)b-d7xg-_r^b5w35$juog!u1osp+!p3i_vdf#o343tl@k*wkh'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["http://lauinirod.pythonanywhere.com/"]
...
LOGIN_URL = 'divermat:iniciar_sesion'
LOGIN_REDIRECT_URL = '/'
LOGOUT_URL = 'divermat:cerrar_sesion'
LOGOUT_REDIRECT_URL = '/'
